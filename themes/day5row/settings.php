 ...
 *
 *   ABOUT THIS PAGE -----
 *   Used For:     Day5row theme Settings file
...
// AdSense color settings
	$theme['ads_header_bg'] = 'e6e6e6';
	$theme['ads_index_bg'] = 'f5f5f5';
	$theme['ads_thumb_bg'] = 'f5f5f5';
	$theme['ads_gallery_bg'] = 'f5f5f5';

// gallery
	$theme['gallery_row_no'] = 5; // number of images per row 
	$theme['gallery_rows'] = 4; // set number of rows
